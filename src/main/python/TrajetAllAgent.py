...
# lire les evenements d'un agent specifique depuis output_events.xml.gz et les ecrire dans TrajetAllAgent.xml
def ecrire_evenements_agent(fichier_entree, agent_id, fichier_sortie):
    with gzip.open(fichier_entree, 'rt', encoding='utf-8') as f:
        ...
        for event in root.findall('event'):
            # verifier si l'evenement correspond à l'agent specifie
...
fichier_entree = "C:/Users/User/IdeaProjects/matsim-example-project-modified/simulation_output_sunday2/output_events.xml.gz"
agent_id = "1002498" 
